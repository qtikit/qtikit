...
export interface BlockContentModel {
  $selection: ["pre", HTMLText] | ["h1", HTMLText] | ["h2", HTMLText] | ["h3", HTMLText] | ["h4", HTMLText] | ["h5", HTMLText] | ["h6", HTMLText] | ["p", HTMLText] | ["address", HTMLText] | ["dl", DL] | ["ol", OUL] | ["ul", OUL] | ["hr", HR] | ["blockquote", BlockQuote] | ["table", Table] | ["div", Div] | ["article", HTML5] | ["aside", HTML5] | ["audio", HTML5] | ["figure", HTML5] | ["footer", HTML5] | ["header", HTML5] | ["nav", HTML5] | ["section", HTML5] | ["video", HTML5];
}
...
export interface BlockGroup {
  $selection: ["positionObjectStage", PositionObjectStage] | ["customInteraction", CustomInteraction] | ["drawingInteraction", DrawingInteraction] | ["gapMatchInteraction", GapMatchInteraction] | ["matchInteraction", MatchInteraction] | ["graphicGapMatchInteraction", GraphicGapMatchInteraction] | ["hotspotInteraction", HotspotInteraction] | ["graphicOrderInteraction", GraphicOrderInteraction] | ["selectPointInteraction", SelectPointInteraction] | ["graphicAssociateInteraction", GraphicAssociateInteraction] | ["sliderInteraction", SliderInteraction] | ["choiceInteraction", ChoiceInteraction] | ["mediaInteraction", MediaInteraction] | ["hottextInteraction", HotTextInteraction] | ["orderInteraction", OrderInteraction] | ["extendedTextInteraction", ExtendedTextInteraction] | ["uploadInteraction", UploadInteraction] | ["associateInteraction", AssociateInteraction] | ["feedbackBlock", FeedbackBlock] | ["templateBlock", TemplateBlock] | ["infoControl", InfoControl] | ["math", MathML2] | ["math", MathML2] | ["include", Include] | ["blockContentModel", BlockContentModel];
}
...
export interface BlockStaticGroup {
  $selection: ["feedbackBlock", FeedbackBlock] | ["templateBlock", TemplateBlock] | ["math", MathML2] | ["math", MathML2] | ["include", Include] | ["blockContentModel", BlockContentModel];
}
...
export interface ExpressionGroup {
  $selection: ["and", Logic1toMany] | ["gt", LogicPair] | ["not", LogicSingle] | ["lt", LogicPair] | ["gte", LogicPair] | ["lte", LogicPair] | ["or", Logic1toMany] | ["sum", NumericLogic1toMany] | ["durationLT", LogicPair] | ["durationGTE", LogicPair] | ["subtract", LogicPair] | ["divide", LogicPair] | ["multiple", Logic0toMany] | ["ordered", Logic0toMany] | ["customOperator", CustomOperator] | ["random", LogicSingle] | ["numberIncorrect", Number] | ["numberCorrect", Number] | ["numberPresented", Number] | ["numberResponded", Number] | ["numberSelected", Number] | ["substring", Substring] | ["equalRounded", EqualRounded] | ["null", Empty] | ["delete", LogicPair] | ["match", LogicPair] | ["index", Index] | ["power", LogicPair] | ["equal", Equal] | ["contains", LogicPair] | ["containerSize", LogicSingle] | ["correct", Correct] | ["default", Default] | ["anyN", AnyN] | ["integerDivide", LogicPair] | ["integerModulus", LogicPair] | ["isNull", LogicSingle] | ["member", LogicPair] | ["product", Logic1toMany] | ["round", LogicSingle] | ["truncate", LogicSingle] | ["fieldValue", FieldValue] | ["randomInteger", RandomInteger] | ["randomFloat", RandomFloat] | ["variable", Variable] | ["outcomeMinimum", OutcomeMinMax] | ["outcomeMaximum", OutcomeMinMax] | ["testVariables", TestVariables] | ["integerToFloat", LogicSingle] | ["inside", Inside] | ["baseValue", BaseValue] | ["patternMatch", PatternMatch] | ["mapResponsePoint", MapResponse] | ["mapResponse", MapResponse] | ["stringMatch", StringMatch] | ["repeat", Repeat] | ["roundTo", RoundTo] | ["lcm", Logic1toMany] | ["gcd", Logic1toMany] | ["min", Logic1toMany] | ["max", Logic1toMany] | ["mathConstant", MathConstant] | ["statsOperator", StatsOperator] | ["mathOperator", MathOperator];
}
...
export interface FeedandTempBlockStatic {
  $selection: ["flowContentModel", FlowContentModel] | ["math", MathML2] | ["math", MathML2] | ["include", Include] | ["templateBlock", TemplateBlock] | ["templateInline", TemplateInline] | ["feedbackBlock", TemplateBlockFeedbackBlock] | ["feedbackInline", FeedbackInline] | ["printedVariable", PrintedVariable];
}
...
export interface FeedbackBlockStatic {
  $selection: ["blockGroup", BlockGroup] | ["inlineContentModel", InlineContentModel] | ["templateInline", TemplateInline] | ["feedbackInline", FeedbackInline] | ["printedVariable", PrintedVariable];
}
...
export interface FeedbackFlowStaticGroup {
  $selection: ["printedVariable", PrintedVariable] | ["hottext", HotText] | ["templateInline", TemplateInline] | ["templateBlock", TemplateBlock] | ["math", MathML2] | ["math", MathML2] | ["include", Include] | ["flowContentModel", FlowContentModel];
}
...
export interface FeedbackInlineGroup {
  $selection: ["inlineContentModel", InlineContentModel] | ["math", MathML2] | ["math", MathML2] | ["include", Include] | ["templateInline", TemplateInline] | ["printedVariable", PrintedVariable];
}
...
export interface FlowContentModel {
  $selection: ["pre", HTMLText] | ["h1", HTMLText] | ["h2", HTMLText] | ["h3", HTMLText] | ["h4", HTMLText] | ["h5", HTMLText] | ["h6", HTMLText] | ["p", HTMLText] | ["address", HTMLText] | ["dl", DL] | ["ol", OUL] | ["ul", OUL] | ["br", BR] | ["hr", HR] | ["img", Img] | ["object", Object] | ["blockquote", BlockQuote] | ["em", HTMLText] | ["a", A] | ["code", HTMLText] | ["span", HTMLText] | ["sub", HTMLText] | ["acronym", HTMLText] | ["big", HTMLText] | ["tt", HTMLText] | ["kbd", HTMLText] | ["q", Q] | ["i", HTMLText] | ["dfn", HTMLText] | ["abbr", HTMLText] | ["strong", HTMLText] | ["sup", HTMLText] | ["var", HTMLText] | ["small", HTMLText] | ["samp", HTMLText] | ["b", HTMLText] | ["cite", HTMLText] | ["table", Table] | ["div", Div] | ["bdo", BDO] | ["bdi", HTML5] | ["figure", HTML5] | ["audio", HTML5] | ["video", HTML5] | ["article", HTML5] | ["aside", HTML5] | ["footer", HTML5] | ["header", HTML5] | ["label", HTML5] | ["nav", HTML5] | ["section", HTML5] | ["ruby", HTML5] | ["ssmlGroup", SSMLGroup];
}
...
export interface FlowGroup {
  $selection: ["printedVariable", PrintedVariable] | ["feedbackBlock", FeedbackBlock] | ["hottext", HotText] | ["feedbackInline", FeedbackInline] | ["templateInline", TemplateInline] | ["templateBlock", TemplateBlock] | ["math", MathML2] | ["math", MathML2] | ["include", Include] | ["textEntryInteraction", TextEntryInteraction] | ["inlineChoiceInteraction", InlineChoiceInteraction] | ["endAttemptInteraction", EndAttemptInteraction] | ["customInteraction", CustomInteraction] | ["drawingInteraction", DrawingInteraction] | ["gapMatchInteraction", GapMatchInteraction] | ["matchInteraction", MatchInteraction] | ["graphicGapMatchInteraction", GraphicGapMatchInteraction] | ["hotspotInteraction", HotspotInteraction] | ["graphicOrderInteraction", GraphicOrderInteraction] | ["selectPointInteraction", SelectPointInteraction] | ["graphicAssociateInteraction", GraphicAssociateInteraction] | ["sliderInteraction", SliderInteraction] | ["choiceInteraction", ChoiceInteraction] | ["mediaInteraction", MediaInteraction] | ["hottextInteraction", HotTextInteraction] | ["orderInteraction", OrderInteraction] | ["extendedTextInteraction", ExtendedTextInteraction] | ["uploadInteraction", UploadInteraction] | ["associateInteraction", AssociateInteraction] | ["flowContentModel", FlowContentModel];
}
...
export interface FlowStaticGroup {
  $selection: ["printedVariable", PrintedVariable] | ["feedbackBlock", FeedbackBlock] | ["feedbackInline", FeedbackInline] | ["templateInline", TemplateInline] | ["templateBlock", TemplateBlock] | ["math", MathML2] | ["math", MathML2] | ["include", Include] | ["flowContentModel", FlowContentModel];
}
...
export interface InlineChoiceGroup {
  $selection: ["printedVariable", PrintedVariable] | ["feedbackInline", FeedbackInline] | ["templateInline", TemplateInline] | ["math", MathML2] | ["math", MathML2] | ["include", Include] | ["inlineContentModel", InlineContentModel];
}
...
export interface InlineContentModel {
  $selection: ["img", Img] | ["br", BR] | ["object", Object] | ["em", HTMLText] | ["a", A] | ["code", HTMLText] | ["span", HTMLText] | ["sub", HTMLText] | ["acronym", HTMLText] | ["big", HTMLText] | ["tt", HTMLText] | ["kbd", HTMLText] | ["q", Q] | ["i", HTMLText] | ["dfn", HTMLText] | ["abbr", HTMLText] | ["strong", HTMLText] | ["sup", HTMLText] | ["var", HTMLText] | ["small", HTMLText] | ["samp", HTMLText] | ["b", HTMLText] | ["cite", HTMLText] | ["bdo", BDO] | ["bdi", HTML5] | ["label", HTML5] | ["ruby", HTML5] | ["ssml11Group", SSMLGroup];
}
...
export interface InlineGroup {
  $selection: ["textEntryInteraction", TextEntryInteraction] | ["hottext", HotText] | ["printedVariable", PrintedVariable] | ["gap", Gap] | ["feedbackInline", FeedbackInline] | ["templateInline", TemplateInline] | ["inlineChoiceInteraction", InlineChoiceInteraction] | ["endAttemptInteraction", EndAttemptInteraction] | ["customInteraction", CustomInteraction] | ["math", MathML2] | ["math", MathML2] | ["include", Include] | ["inlineContentModel", InlineContentModel];
}
...
export interface InlineStaticGroup {
  $selection: ["hottext", HotText] | ["printedVariable", PrintedVariable] | ["gap", Gap] | ["feedbackInline", FeedbackInline] | ["templateInline", TemplateInline] | ["math", MathML2] | ["math", MathML2] | ["include", Include] | ["inlineContentModel", InlineContentModel];
}
...
export interface NumericExpressionGroup {
  $selection: ["sum", NumericLogic1toMany] | ["subtract", LogicPair] | ["divide", LogicPair] | ["multiple", Logic0toMany] | ["ordered", Logic0toMany] | ["customOperator", CustomOperator] | ["random", LogicSingle] | ["numberIncorrect", Number] | ["numberCorrect", Number] | ["numberPresented", Number] | ["numberResponded", Number] | ["numberSelected", Number] | ["null", Empty] | ["delete", LogicPair] | ["index", Index] | ["power", LogicPair] | ["containerSize", LogicSingle] | ["correct", Correct] | ["default", Default] | ["integerDivide", LogicPair] | ["integerModulus", LogicPair] | ["product", Logic1toMany] | ["round", LogicSingle] | ["truncate", LogicSingle] | ["fieldValue", FieldValue] | ["randomInteger", RandomInteger] | ["variable", Variable] | ["outcomeMinimum", OutcomeMinMax] | ["outcomeMaximum", OutcomeMinMax] | ["testVariables", TestVariables] | ["integerToFloat", LogicSingle] | ["baseValue", BaseValue] | ["mapResponsePoint", MapResponse] | ["mapResponse", MapResponse] | ["repeat", Repeat] | ["roundTo", RoundTo] | ["lcm", Logic1toMany] | ["gcd", Logic1toMany] | ["min", Logic1toMany] | ["max", Logic1toMany] | ["mathConstant", MathConstant] | ["statsOperator", StatsOperator] | ["mathOperator", MathOperator] | ["randomFloat", RandomFloat];
}
...
export interface ObjectFlowGroup {
  $selection: ["math", MathML2] | ["math", MathML2] | ["include", Include] | ["param", Param] | ["flowContentModel", FlowContentModel];
}
...
export interface OutcomeRule {
  $selection: ["lookupOutcomeValue", LookupOutcomeValue] | ["outcomeProcessingFragment", OutcomeProcessingFragment] | ["setOutcomeValue", SetValue] | ["include", Include] | ["exitTest", Empty] | ["outcomeCondition", OutcomeCondition];
}
...
export interface ResponseRuleGroup {
  $selection: ["include", Include] | ["responseCondition", ResponseCondition] | ["responseProcessingFragment", ResponseProcessingFragment] | ["setOutcomeValue", SetValue] | ["exitResponse", Empty] | ["lookupOutcomeValue", LookupOutcomeValue];
}
...
export interface RubricBlockContentModel {
  $selection: ["flowContentModel", FlowContentModel] | ["math", MathML2] | ["math", MathML2] | ["include", Include] | ["templateBlock", RubricBlockTemplateBlock] | ["templateInline", RubricBlockTemplateInline] | ["printedVariable", PrintedVariable];
}
...
export interface RubricTemplateBlockContentModel {
  $selection: ["flowContentModel", FlowContentModel] | ["math", MathML2] | ["math", MathML2] | ["include", Include] | ["templateBlock", RubricBlockTemplateBlock] | ["printedVariable", PrintedVariable];
}
...
export interface RubricTemplateInlineStaticGroup {
  $selection: ["inlineContentModel", InlineContentModel] | ["math", MathML2] | ["math", MathML2] | ["include", Include] | ["templateInline", RubricBlockTemplateInline] | ["printedVariable", PrintedVariable];
}
...
export interface SSMLGroup {
  $selection: ["p", SSMLv1p1] | ["s", SSMLv1p1] | ["say-as", SSMLv1p1] | ["phoneme", SSMLv1p1] | ["sub", SSMLv1p1] | ["voice", SSMLv1p1] | ["emphasis", SSMLv1p1] | ["break", SSMLv1p1] | ["prosody", SSMLv1p1] | ["mark", SSMLv1p1] | ["audio", SSMLv1p1] | ["speak", SSMLv1p1];
}
...
export interface SectionPart {
  $selection: ["include", Include] | ["assessmentItemRef", AssessmentItemRef] | ["assessmentSection", AssessmentSection] | ["assessmentSectionRef", AssessmentSectionRef];
}
...
export interface TemplateRuleGroup {
  $selection: ["setTemplateValue", SetValue] | ["exitTemplate", Empty] | ["templateCondition", TemplateCondition] | ["setDefaultValue", SetValue] | ["setCorrectResponse", SetValue] | ["templateConstraint", TemplateConstraint];
}
 ...
 */
export type ARIARoleValue = "article" | "button" | "checkbox" | "columnheader" | "complementary" | "contentinfo" | "definition" | "directory" | "document" | "gridcell" | "group" | "heading" | "img" | "link" | "list" | "listbox" | "listitem" | "log" | "math" | "note" | "option" | "presentation" | "radio" | "radiogroup" | "region" | "row" | "rowgroup" | "rowheader" | "separator" | "slider" | "spinbutton" | "status" | "tab" | "tablist" | "tabpanel" | "textbox" | "timer" | "toolbar";
 ...
 */
export type BaseType = "boolean" | "directedPair" | "duration" | "file" | "float" | "identifier" | "integer" | "pair" | "point" | "string" | "uri";
 ...
 */
export type MathOperatorName = "abs" | "acos" | "acot" | "acsc" | "asec" | "asin" | "atan" | "atan2" | "ceil" | "cos" | "cosh" | "cot" | "coth" | "csc" | "csch" | "exp" | "floor" | "ln" | "log" | "sec" | "sech" | "signum" | "sin" | "sinh" | "tan" | "tanh" | "toDegrees" | "toRadians";
