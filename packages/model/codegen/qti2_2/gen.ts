...
export default function gen(spec: Spec): string {
  const codes: string[] = ['// This file was automatically generated. do not edit by hand.\n\n'];
...
function genClass(spec: Spec, def: Class): string {
  ...
  const {primitiveAncestors, characteristics, attributes} = expandClass(spec, def);
  ...
  const extendsCode = extendTypes.length ? ` extends ${extendTypes.join(', ')}` : '';
